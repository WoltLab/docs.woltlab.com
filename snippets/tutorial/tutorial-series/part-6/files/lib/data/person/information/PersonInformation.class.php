...
class PersonInformation extends DatabaseObject
{
    ...
    /**
     * Returns a formatted excerpt of the information.
     */
    public function getFormattedExcerpt(int $maxLength = 255): string
    {
        ...
        return StringUtil::truncateHTML($processor->getHtml(), $maxLength);
    }
