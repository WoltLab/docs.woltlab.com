...
Version 3.0 deprecated the `Emogrifier` class in favor of the `CssInliner` class that was added in 2.1.
The `Emogrifier` class was subsequently removed in version 4.0.

No compatibility layer was added for the `Emogrifier` class, as the Emogrifier library's purpose was for use within the email subsystem of WoltLab Suite.
...
Double check your CSS declarations and specifically the specificity of your selectors in these cases.
